...
public class Pensionados {
	...
	public void comproDatos() {
		int tecla = 0;
		System.out.println();
		System.out.print("Si tus datos están correctos, presiona '1' si no, presiona '0': ");
		try{
			dato = br.readLine();
			tecla = Integer.parseInt(dato);
		}catch(NumberFormatException e) {
			System.out.println("Dato inválido se tomara por " + tecla);
		}catch(IOException e) {}
		System.out.println();
		if(tecla != 1) {
			this.contraFecha();
